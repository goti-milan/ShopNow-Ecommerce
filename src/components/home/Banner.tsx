...
const slides: BannerSlide[] = [
  ...
  },
  {
    ...
    bgGradient: "from-primary via-primary to-primary-dark",
  ...
  return (
    <div className="relative w-full overflow-hidden rounded-2xl my-6">
      ...
      >
        ...
        <div className="absolute -top-40 -right-40 w-96 h-96 bg-background/10 rounded-full blur-3xl pointer-events-none"></div>
