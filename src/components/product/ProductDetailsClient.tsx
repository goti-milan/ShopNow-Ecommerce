                    ...
                    <div className="flex flex-col gap-8">
                                ...
                                {colors.map((color) => (
                                    <button
                                        ...
                                        className={cn(
                                            ...
                                            selectedColor === color.id ? "border-primary scale-110" : "border-transparent hover:border-border"
                                        )}
                                    >
                                        <div
                                        ...
                                        {selectedColor === color.id && (
                                            <div className="absolute -top-1 -right-1 w-4 h-4 bg-accent0 rounded-full flex items-center justify-center border-2 border-white">
                        ...
                        <div className="space-y-6 pt-2">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="p-4 rounded-2xl border border-border bg-muted flex items-start gap-3">
