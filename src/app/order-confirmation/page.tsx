                        ...
                        <div className="bg-background rounded-[40px] shadow-2xl shadow-orange-100 overflow-hidden border border-white">
                            <div className="bg-secondary p-12 text-center relative overflow-hidden">
                                ...
                                <div className="relative z-10 space-y-6">
                                    ...
                                    <h1 className="text-5xl font-semibold text-white tracking-tighter italic">Order Confirmed!</h1>
                                    ...
                                    <div className="inline-block bg-background/5 backdrop-blur-md px-6 py-3 rounded-2xl border border-white/10">
                                        ...
                                        <span className="text-white font-semibold text-xl tracking-wide">{orderId}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="p-10 space-y-10">
                                ...
                                <div className="grid md:grid-cols-3 gap-6">
                                    <div className="bg-muted p-8 rounded-3xl border border-border space-y-4 hover:shadow-xl transition-all hover:-translate-y-1 duration-300">
                                        ...
                                        <h3 className="font-semibold text-foreground text-lg">Processing</h3>
                                    ...
                                    <div className="bg-muted p-8 rounded-3xl border border-border space-y-4 hover:shadow-xl transition-all hover:-translate-y-1 duration-300">
                                        ...
                                        <h3 className="font-semibold text-foreground text-lg">Shipping</h3>
                                    ...
                                    <div className="bg-muted p-8 rounded-3xl border border-border space-y-4 hover:shadow-xl transition-all hover:-translate-y-1 duration-300">
                                        ...
                                        <h3 className="font-semibold text-foreground text-lg">Delivery</h3>
                                        <p className="text-sm text-muted-foreground font-medium leading-relaxed">Estimated delivery in <span className="text-primary font-semibold italic underline decoration-2 underline-offset-4">3-5 business days</span>.</p>
                                    </div>
                                </div>
                                ...
                                <div className="bg-secondary p-8 rounded-[32px] text-white flex flex-col md:flex-row justify-between items-center gap-8">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <p className="text-muted-foreground text-xs font-semibold uppercase tracking-widest">Payment Method</p>
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <p className="text-muted-foreground text-xs font-semibold uppercase tracking-widest">Amount Paid</p>
                                            <p className="text-2xl font-semibold italic tracking-tighter">₹45,990.00</p>
                                        </div>
                                    </div>
                                    <Link href="/account/orders" className="w-full md:w-auto">
                                        <Button className="w-full bg-primary hover:bg-primary-dark text-white font-semibold px-8 py-7 rounded-2xl shadow-lg shadow-orange-500/20 transform hover:-translate-y-1 transition-all active:scale-95 text-lg">
                                ...
                                <div className="pt-4 flex flex-col items-center gap-4">
                                    ...
                                    <Link href="/">
                                        <Button variant="ghost" className="text-foreground hover:text-primary font-semibold gap-2 text-lg">
                        ...
                        <div className="bg-background rounded-[40px] shadow-2xl overflow-hidden border-2 border-primary/10">
                            <div className="bg-accent0 p-16 text-center relative overflow-hidden">
                                ...
                                <div className="relative z-10 space-y-6">
                                    ...
                                    <h1 className="text-5xl font-semibold text-white tracking-tighter italic">Payment Failed</h1>
                            ...
                            <div className="p-12 text-center space-y-10">
                                <div className="max-w-md mx-auto space-y-6">
                                    <div className="bg-accent p-6 rounded-3xl border border-primary/20 flex items-start gap-4 text-left">
                                        ...
                                        <div className="space-y-1">
                                            <h4 className="font-semibold text-foreground uppercase tracking-wide text-sm">Suggested Reason</h4>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="p-4 rounded-2xl bg-muted border border-border text-left">
                                            <p className="text-[10px] font-semibold text-muted-foreground uppercase tracking-widest mb-1">Error Code</p>
                                            <p className="font-bold text-foreground tracking-wider">ERR_TRANS_901</p>
                                        </div>
                                        <div className="p-4 rounded-2xl bg-muted border border-border text-left">
                                            <p className="text-[10px] font-semibold text-muted-foreground uppercase tracking-widest mb-1">Time</p>
                                ...
                                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                    <Button
                                        ...
                                        className="bg-secondary hover:bg-secondary text-white font-semibold px-10 py-8 rounded-2xl shadow-xl transform hover:-translate-y-1 transition-all active:scale-95 text-xl flex-1 sm:flex-none uppercase tracking-tighter"
                                    >
                                        <RefreshCw className="mr-2 w-5 h-5" /> Retry Payment
                                    </Button>
                                    <Link href="/" className="flex-1 sm:flex-none">
                                        <Button variant="outline" className="w-full border-border hover:bg-muted text-muted-foreground font-semibold px-10 py-8 rounded-2xl text-xl uppercase tracking-tighter">
                                            Cancel Order
                                        </Button>
                                    </Link>
                                </div>
                                ...
                                <div className="pt-4">
                                    <p className="text-muted-foreground font-bold italic">
                                        Need help? Contact our <Link href="/contactus" className="text-primary underline underline-offset-4 decoration-2">support team</Link> or call <span className="text-foreground not-italic font-semibold">+91 0000 000 000</span>
                                    </p>
                                </div>
                            </div>
                        </div>
