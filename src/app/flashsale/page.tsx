...
export default function FlashSalePage() {
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            {/* Banner */}
            <div className="bg-gradient-to-r from-primary to-primary-dark rounded-2xl p-8 mb-12 text-white text-center shadow-lg relative overflow-hidden">
                <div className="relative z-10">
                    ...
                    <div className="flex justify-center gap-4">
                        <div className="bg-background/20 backdrop-blur-sm rounded-lg p-3 min-w-[80px]">
                ...
                {/* Decorative Circles */}
                <div className="absolute top-0 left-0 w-64 h-64 bg-background opacity-5 rounded-full -ml-32 -mt-32"></div>
                <div className="absolute bottom-0 right-0 w-96 h-96 bg-secondary opacity-10 rounded-full -mr-48 -mb-48"></div>
            </div>
